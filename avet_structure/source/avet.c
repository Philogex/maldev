...
#ifdef SHELLCODE_SECTION
//optimally this should be a self decoding shellcode
__attribute__((section(".shellcode"))) static unsigned char shellcode_storage[] = {
...
{		
	...
	#elif SHELLCODE_SECTION
	unsigned char *encoded_payload = get_payload(shellcode_storage, &payload_size);
	#else
