...
# Following actually works now. Add -ast-dump-filter <arg> after the -ast-dump argument to filter for a specific node
clang-check-17 src/main.cpp -ast-dump -- -target x86_64-w64-mingw32 -I/usr/lib/gcc/x86_64-w64-mingw32/13-win32/include/c++/x86_64-w64-mingw32/ -I/usr/lib/gcc/x86_64-w64-mingw32/13-win32/include/c++/ > out/main_ast_dump.txt
